...
extension XCTestCase {
    ...
    */
    var testAttitudeData: Data {
        ...
        return Data(bytes: [0xEF, 0x1C, 0x00, 0x01, 0x01, 0x1E, 0x7E, 0x19, 0x01, 0x00, 0x64, 0x6A, 0x8E, 0xBD, 0xB2, 0x0D, 0xDF, 0x3C, 0x5B, 0xD7, 0x8E, 0x3F, 0xEA, 0xC2, 0xAA, 0xBC, 0x56, 0x96, 0x15, 0x3C, 0x51, 0x30, 0xDA, 0x3A, 0x12, 0xAB])
    ...
    var testHeartbeatData: Data {
        /// FIXED BY GANGTI/20190110/MAVLINK CUSTOMIZATION
        return Data(bytes: [0xEF,0x09,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x08,0x00,0x00,0x03,0xA1,0xDF])
        /// CLOSE BY GANGTI/20190110/MAVLINK CUSTOMIZATION
    }
    
    var testStatustextData: Data {
        /// FIXED BY GANGTI/20190110/MAVLINK CUSTOMIZATION
        return Data(bytes: [0xEF,0x33,0x00,0x01,0x01,0xFD,0x01,0x41,0x50,0x4D,0x3A,0x43,0x6F,0x70,0x74,0x65,0x72,0x20,0x56,0x33,0x2E,0x34,0x2D,0x64,0x65,0x76,0x20,0x28,0x62,0x64,0x64,0x64,0x66,0x61,0x65,0x35,0x29,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x90,0x07])
        /// CLOSE BY GANGTI/20190110/MAVLINK CUSTOMIZATION
    }
}
